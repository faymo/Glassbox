  ...
  return (
    <div className="w-full h-16 bg-neutral-900 border-b border-zinc-800 flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="text-white text-lg font-medium italic font-lexend">
          Glassbox
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="w-44 h-9 bg-neutral-800 rounded-md flex items-center gap-2 px-4 hover:bg-neutral-700 transition-colors">
          <svg width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5.85 4.55H9.425L5.85 0.975V4.55ZM1.3 0H6.5L10.4 3.9V11.7C10.4 12.0448 10.263 12.3754 10.0192 12.6192C9.77544 12.863 9.44478 13 9.1 13H1.3C0.5785 13 0 12.415 0 11.7V1.3C0 0.5785 0.5785 0 1.3 0ZM7.15 10.4V9.1H1.3V10.4H7.15ZM9.1 7.8V6.5H1.3V7.8H9.1Z" fill="white"/>
          </svg>
          <span className="text-white text-base font-medium">Documentation</span>
        </button>
